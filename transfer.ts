import { Transaction, SystemProgram, Connection, Keypair,
    ...
    const to = new PublicKey("EQKcZP28o5Xj5RQVDa7FUs5FLbReUxZmbiiUubfbsJ88");
    ...
    console.error(`Oops, something went wrong1: ${e}`)
    }
    })();
...
(async () => {
    try {
            ...
            transaction.recentBlockhash = (await
                ...
                transaction.feePayer = from.publicKey;// Calculate exact fee rate to transfer entire SOL amount out of account minus fees
                const fee = (await
            ...
            console.error(`Oops, something went wrong2: ${e}`)
            }
}
)();
